...
test('Insert log message related to a function parameter', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/functionParam.ts');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(2, 49), new vscode.Position(2, 66)),
        ];
...
//# sourceMappingURL=functionParam.test.js.map