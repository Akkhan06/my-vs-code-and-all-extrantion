...
test('Insert log message related to a multiline function parameter ', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/functionMultiLineParameters.ts');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(1, 2), new vscode.Position(1, 13)),
        ];
        ...
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(2, 2), new vscode.Position(2, 13)),
        ];
        yield vscode.commands.executeCommand('turboConsoleLog.displayLogMessage', []);
...
//# sourceMappingURL=functionMultiLineParameters.test.js.map