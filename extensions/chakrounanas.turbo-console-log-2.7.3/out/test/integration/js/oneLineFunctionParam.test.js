...
test('Insert log message related to a function (which params are defined in one line) param', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/oneLineFunctionParam.js');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(0, 18), new vscode.Position(0, 26)),
        ];
...
//# sourceMappingURL=oneLineFunctionParam.test.js.map