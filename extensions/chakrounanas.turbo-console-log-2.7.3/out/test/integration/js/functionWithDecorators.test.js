...
test('Insert log message in the context of a function with a bunch of decorators', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/functionWithDecorators.ts');
    const { activeTextEditor } = vscode.window;
    const zeroBasedLineHelper = helpers_1.zeroBasedLine;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new helpers_1.ZeroBasedPosition(9, 20), new helpers_1.ZeroBasedPosition(9, 24)),
        ];
...
//# sourceMappingURL=functionWithDecorators.test.js.map