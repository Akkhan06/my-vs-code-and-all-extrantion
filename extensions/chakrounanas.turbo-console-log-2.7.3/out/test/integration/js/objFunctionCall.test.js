...
test('Insert log message related to an object function call', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/objFunctionCall.ts');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(3, 3), new vscode.Position(3, 20)),
        ];
...
//# sourceMappingURL=objFunctionCall.test.js.map