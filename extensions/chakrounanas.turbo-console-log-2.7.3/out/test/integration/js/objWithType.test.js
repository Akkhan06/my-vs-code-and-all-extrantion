...
test('Object variable with a declared type', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/objWithType.ts');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(4, 10), new vscode.Position(4, 18)),
        ];
...
//# sourceMappingURL=objWithType.test.js.map