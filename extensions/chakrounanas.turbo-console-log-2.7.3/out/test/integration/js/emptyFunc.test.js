...
suite('Empty functions', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    mocha_1.default.afterEach(() => __awaiter(void 0, void 0, void 0, function* () {
        yield helpers_1.openDocument('../files/js/emptyFunc.ts');
    }));
    mocha_1.default.afterEach(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('Example 01', () => __awaiter(void 0, void 0, void 0, function* () {
        if (activeTextEditor) {
            activeTextEditor.selections = [
                new vscode.Selection(new helpers_1.ZeroBasedPosition(5, 15), new helpers_1.ZeroBasedPosition(5, 30)),
            ];
            yield vscode.commands.executeCommand('turboConsoleLog.displayLogMessage', []);
            const textDocument = activeTextEditor.document;
            assert.strictEqual(/\{\s*$/.test(textDocument.lineAt(zeroBasedLineHelper(7)).text), true);
    ...
    test('Example 02', () => __awaiter(void 0, void 0, void 0, function* () {
        if (activeTextEditor) {
            activeTextEditor.selections = [
                new vscode.Selection(new helpers_1.ZeroBasedPosition(14, 19), new helpers_1.ZeroBasedPosition(14, 25)),
            ];
            yield vscode.commands.executeCommand('turboConsoleLog.displayLogMessage', []);
            const textDocument = activeTextEditor.document;
            assert.strictEqual(/\{\s*$/.test(textDocument.lineAt(zeroBasedLineHelper(14)).text), true);
            const logMessage = textDocument.lineAt(zeroBasedLineHelper(15)).text;
            assert.strictEqual(/console\.log\(.*/.test(logMessage), true);
        }
    }));
}));
//# sourceMappingURL=emptyFunc.test.js.map