...
test('Insert log message related to a class constructor param', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/classConstructor.js');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(1, 14), new vscode.Position(1, 22)),
        ];
...
//# sourceMappingURL=classConstructor.test.js.map