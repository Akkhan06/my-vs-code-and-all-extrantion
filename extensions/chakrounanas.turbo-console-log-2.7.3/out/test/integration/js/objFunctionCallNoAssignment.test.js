...
test('Obj function call no variable assignment', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/objFunctionCallNoAssignment.ts');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(3, 2), new vscode.Position(3, 20)),
        ];
...
//# sourceMappingURL=objFunctionCallNoAssignment.test.js.map