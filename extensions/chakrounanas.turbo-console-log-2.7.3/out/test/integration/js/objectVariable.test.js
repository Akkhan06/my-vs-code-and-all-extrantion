...
test('Insert log message related to an object variable', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/objectVariable.js');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(0, 6), new vscode.Position(0, 12)),
        ];
...
//# sourceMappingURL=objectVariable.test.js.map