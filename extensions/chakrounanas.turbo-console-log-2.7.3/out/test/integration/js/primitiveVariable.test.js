...
test('Insert log message related to a primitive variable', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/primitiveVariable.js');
    const { activeTextEditor } = vscode.window;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new vscode.Position(0, 6), new vscode.Position(0, 14)),
        ];
...
//# sourceMappingURL=primitiveVariable.test.js.map