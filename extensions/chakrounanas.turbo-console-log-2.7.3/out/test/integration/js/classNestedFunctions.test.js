...
test('Insert log message related to a function parameter within a class function', () => __awaiter(void 0, void 0, void 0, function* () {
    yield helpers_1.openDocument('../files/js/classNestedFunctions.js');
    const { activeTextEditor } = vscode.window;
    const zeroBasedLineHelper = helpers_1.zeroBasedLine;
    if (activeTextEditor) {
        activeTextEditor.selections = [
            new vscode.Selection(new helpers_1.ZeroBasedPosition(3, 30), new helpers_1.ZeroBasedPosition(3, 42)),
        ];
...
//# sourceMappingURL=classNestedFunctions.test.js.map